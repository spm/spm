...
%
% The next component specifies any design matrix orthogonalisation:
%
% D.Xorth    - a structure with fields 'GwB', 'HwBG', 'CwBG' & 'CwH',
%              whose values are binary, with ones indicating that the
%              particular orthogonalisation should be performed. These
%              are performed in the order stated above, and are 'G with
%              respect to B', 'H wirit [B,G]', 'C wirit [B,G]', & 'C
%              wirit H'.
%
