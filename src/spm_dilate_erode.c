/*
 * $Id: spm_dilate_erode.c 112 2005-05-04 18:20:52Z john $
 */
                 ...
                 const mxArray   *prhs[])   /* Input arguments. */
{
   ...
   if (nrhs == 0) mexErrMsgTxt("usage: ima = spm_dilate_erode(ima,kernel,function)");
   if (nrhs != 3) mexErrMsgTxt("spm_dilate_erode: 3 input arguments required");
   if (nlhs != 1) mexErrMsgTxt("spm_dilate_erode: 1 output argument required");
