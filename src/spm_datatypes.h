/* 
 * $Id: spm_datatypes.h 7931 2020-08-17 21:29:54Z john $
 * John Ashburner
 */
...
#define SPM_SIGNED_LONG_LONG_S (SPM_SIGNED_LONG_LONG<<8) 
#define SPM_UNSIGNED_LONG_LONG_S (SPM_UNSIGNED_LONG_LONG<<8)
