...
if V(3) == 1
	...
	X1   = text(0,0,'<','Color','r','Fontsize',16,...
			'Tag','X1',...
			'ButtonDownFcn','spm_mip_ui(''MoveStart'')');
	X1g  = text(0,0,'<','Color','g','Fontsize',12,...
			'Tag','X1g','Visible','off');
else
	%-Create point markers
	%--------------------------------------------------------------
	X1   = text(Po1,Po2,'<','Color','r','Fontsize',16,...
			'Tag','X1',...
			'ButtonDownFcn','spm_mip_ui(''MoveStart'')');
	X2   = text(Po1,Po3,'<','Color','r','Fontsize',16,...
			'Tag','X2',...
			'ButtonDownFcn','spm_mip_ui(''MoveStart'')');
	X3   = text(Po4,Po3,'<','Color','r','Fontsize',16,...
			'Tag','X3',...
			'ButtonDownFcn','spm_mip_ui(''MoveStart'')');
...
hXstr = text(0,1.0,sprintf('x = 0.00'),'FontSize',10,...
		'Tag','hXstr');
hYstr = text(0,0.5,sprintf('y = 0.00'),'FontSize',10,...
		'Tag','hYstr');
hZstr = text(0,0.0,sprintf('z = 0.00'),'FontSize',10,...
		'Tag','hZstr');
...
%-----------------------------------------------------------------------
xyz  = spm_mip_ui('GetCoords');
AXIS = get(findobj('Tag','hMIPaxes'),'UserData');
V    = get(findobj('Tag','hV'),'UserData');
...
%-Get useful data from UserData ofgco, the object to be dragged
%-----------------------------------------------------------------------
