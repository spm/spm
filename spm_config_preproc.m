...
% John Ashburner
% $Id: spm_config_preproc.m 218 2005-08-26 14:18:37Z john $
...
output     = branch('Output Files','output',{grey,white,csf,biascor});
output.help = {[...
...
'the original.  You can also produce spatially normalised versions - both with (mwc*) and without (wc*) ',...
