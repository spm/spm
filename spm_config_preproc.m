...
grey.val   = {[0 0 1]};
grey.help  = {'Options to produce c1*.img, wc1*.img and mwc1*.img'};
white      = grey;
white.name = 'White Matter';
white.tag  = 'WM';
white.help = {'Options to produce c2*.img, wc2*.img and mwc2*.img'};
csf        = grey;
csf.name   = 'Cerebro-Spinal Fluid';
csf.tag    = 'CSF';
csf.val    = {[0 0 0]};
csf.help   = {'Options to produce c3*.img, wc3*.img and mwc3*.img'};
