...
% For the curious, I [Ged] chose this algorithm because it requires no
% special handling of 0 or 100, and lets 0 and 1 percentiles differ even
% with less than 100 samples. It also has the appealing (though perhaps
% totally inconsequential!) property of returning uniformly spaced values
...
% Ged Ridgway
% $Id: spm_percentile.m 3960 2010-06-30 17:41:24Z ged $
...
if all(p < 1) && any(p > 0)
    warning('spm_percentile:fractions', ...
