...
p5 = spm_justify(w,...
    'Otherwise enter a customized set of movements to model');
...
unnecessary.help = spm_justify(w,...
    'Precalculated phase maps not included in unwarping.');
%----------------------------------------------------------------------
...
p1             = spm_justify(w,...
    'Choose data with or without phasemap correction');
p2             = spm_justify(w,...
...
opts.help = {p1{:},'',p2{:},p3{:},'',p4{:},'',p5{:},'',p6{:},'',p7{:},'',...
