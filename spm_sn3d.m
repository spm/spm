...
if (nargin == 0)
	...
	for i=1:nsubjects,
		...
		if a1 == 1 | a1 == 3,
         if isempty(BCH)
           ...
           if isempty(BCH)
             ...
             subj(i).objmask = spm_input('batch',...
             {},objmask',i);
           end
			end;
        ...
        if isempty(BCH)       
          ...
          subj(i).matname = spm_input('batch',...
          {},'matname',i);
        end
		end;
