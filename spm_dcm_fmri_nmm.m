...
% Karl Friston
% $Id: spm_dcm_fmri_nmm.m 6855 2016-08-06 10:06:35Z karl $
...
% check options
%==========================================================================
try, DCM.options.nmm;        catch, DCM.options.nmm        = 'CMC'; end
...
%--------------------------------------------------------------------------
[pE,pC]    = spm_dcm_neural_priors(DCM.a,DCM.b,DCM.c,DCM.options.nmm);
[xn,fn]    = spm_dcm_x_neural(pE,DCM.options.nmm);
...
%--------------------------------------------------------------------------
M.IS = @spm_gen_fmri;                    % equations of motion
M.fn = fn;
