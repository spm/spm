...
priors = files('Prior probability maps','priors','image',3);
...
priors.help = {p0{:},'',p1{:},'',p2{:}};

%------------------------------------------------------------------------

ngaus      = entry('Gaussians per class','ngaus','n',[4 1]);
ngaus.val  = {[2 2 2 4]};
ngaus.help = spm_justify(w,[...
...
job.opts.priors = strvcat(job.opts.priors{:});
