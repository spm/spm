...
% Vladimir Litvak
% $Id: spm_eeg_inv_checkforward.m 7010 2017-02-07 18:15:30Z vladimir $
...
try
    ft_plot_sens(sens, 'style', '*', 'edgecolor', 'g', 'coil', ft_senstype(sens, 'eeg'));
catch
    ft_plot_sens(sens, 'edgecolor', 'g', 'coilshape', 'point', 'coil', true);
end
