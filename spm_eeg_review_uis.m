...
switch objects.type
    ...
    case 'buttons'
        ...
        if ismember(1,objects.list) % save button
...
%             'sliderstep',[(xlim(2)/20)/(D.Nsamples-1) (xlim(2)/5)/(D.Nsamples-1)],...
            ...
            D.PSD.handles.BUTTONS.goMinusOne = uicontrol(D.PSD.handles.hfig,'style',...
                ...
                'Position',[0.875 0.02 0.025 0.02].*repmat(POS(3:4),1,2),'callback',...
        ...
        if ismember(7,objects.list) % event selection button
            ...
            if objects.options.multSelect == 1
                D.PSD.handles.BUTTONS.pop1 = uicontrol(D.PSD.handles.hfig,'Position',...
                    [0.42 0.834 0.25 0.13].*repmat(POS(3:4),1,2),...
                ...
                trN = trN(1);
                D.PSD.handles.BUTTONS.pop1 = uicontrol(D.PSD.handles.hfig,'Position',...
                    [0.42 0.825 0.25 0.13].*repmat(POS(3:4),1,2),...
        ...
        if ismember(11,objects.list)  % display switch (standard/scalp)...
            ...
            D.PSD.handles.BUTTONS.displaySwitch1 = uicontrol(D.PSD.handles.hfig,'Position',...
                [0.69 0.945 0.1 0.02].*repmat(POS(3:4),1,2),...
            ...
            D.PSD.handles.BUTTONS.displaySwitch2 = uicontrol(D.PSD.handles.hfig,'Position',...
                [0.69 0.925 0.1 0.02].*repmat(POS(3:4),1,2),...
        ...
        if ismember(13,objects.list)  % sensor buttons for data info modifs
...
%             D.PSD.handles.BUTTONS.loadSpos = uicontrol(D.PSD.handles.hfig,'Position',...
%                 [0.7 0.66 0.2 0.02].*repmat(POS(3:4),1,2),...
%                 'style','pushbutton','string','load 3D positions',...
%                 'callback','spm_eeg_review_callbacks(''edit'',''sensorPos'')',...
%                 'tooltipstring','load sensor/fiducial positions',...
%                 'enable','off',...
%                 'BusyAction','cancel',...
%                 'Interruptible','off',...
%                 'tag','plotEEG');
%             set(D.PSD.handles.BUTTONS.loadSpos,'units','normalized')
%             D.PSD.handles.BUTTONS.coregSpos = uicontrol(D.PSD.handles.hfig,'Position',...
%                 [0.7 0.63 0.2 0.02].*repmat(POS(3:4),1,2),...
%                 'style','pushbutton','string','coregistrate sensors',...
%                 'callback','spm_eeg_review_callbacks(''edit'',''coregSpos'')',...
%                 'tooltipstring','coregistrate EEG/MEG sensor positions',...
%                 'enable','off',...
%                 'BusyAction','cancel',...
%                 'Interruptible','off',...
%                 'tag','plotEEG');
%             set(D.PSD.handles.BUTTONS.coregSpos,'units','normalized')
%             D.PSD.handles.BUTTONS.volSens = uicontrol(D.PSD.handles.hfig,'Position',...
%                 [0.7 0.60 0.2 0.02].*repmat(POS(3:4),1,2),...
%                 'style','pushbutton','string','prepare Vol/Sens',...
%                 'callback','spm_eeg_review_callbacks(''edit'',''volSens'')',...
%                 'tooltipstring','prepare volumic sensor space',...
%                 'enable','off',...
%                 'BusyAction','cancel',...
%                 'Interruptible','off',...
%                 'tag','plotEEG');
%             set(D.PSD.handles.BUTTONS.volSens,'units','normalized')
%             D.PSD.handles.BUTTONS.load2Dpos = uicontrol(D.PSD.handles.hfig,'Position',...
%                 [0.7 0.55 0.2 0.02].*repmat(POS(3:4),1,2),...
%                 'style','pushbutton','string','load 2D positions',...
%                 'callback','spm_eeg_review_callbacks(''edit'',''2Dpos'')',...
%                 'tooltipstring','load 2D positions for visualization purposes',...
%                 'enable','off',...
%                 'BusyAction','cancel',...
%                 'Interruptible','off',...
%                 'tag','plotEEG');
%             set(D.PSD.handles.BUTTONS.load2Dpos,'units','normalized')
%             D.PSD.handles.BUTTONS.projectPos = uicontrol(D.PSD.handles.hfig,'Position',...
%                 [0.7 0.52 0.2 0.02].*repmat(POS(3:4),1,2),...
%                 'style','pushbutton','string','project 3D positions',...
%                 'callback','spm_eeg_review_callbacks(''edit'',''project3Dpos'')',...
%                 'tooltipstring','project 3D positions for visualization purposes',...
%                 'enable','off',...
%                 'BusyAction','cancel',...
%                 'Interruptible','off',...
%                 'tag','plotEEG');
%             set(D.PSD.handles.BUTTONS.projectPos,'units','normalized')
        end
