    ...
    case 'buttons'
        ...
        if ismember(1,objects.list) % save/prep button
            D.PSD.handles.BUTTONS.pop1 = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.89 0.975 0.1 0.02],...
            ...
            D.PSD.handles.BUTTONS.prep = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.7 0.975 0.18 0.02],...
        ...
        if ismember(2,objects.list) % temporal sliders buttons
            ...
            D.PSD.handles.BUTTONS.goMinusOne = uicontrol(D.PSD.handles.hfig,'style',...
                ...
                'units','normalized','Position',[0.06 0.02 0.02 0.02],...
                'callback',...
            ...
            D.PSD.handles.BUTTONS.goPlusOne = uicontrol(D.PSD.handles.hfig,'style',...
                ...
                'units','normalized','Position',[0.942 0.02 0.02 0.02],...
                'callback',...
                'spm_eeg_review_callbacks(''visu'',''goOne'',+1)',...
                'BusyAction','cancel',...
                'Interruptible','off',...
        ...
        if ismember(3,objects.list) % width of time window
            D.PSD.handles.BUTTONS.vb3 = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.02 0.925 0.05 0.04],...
                'cdata',Y5,...
            ...
            D.PSD.handles.BUTTONS.vb4 = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.08 0.925 0.05 0.04],...
                'cdata',Y6,...
        ...
        if ismember(4,objects.list) % Global scaling buttons
            D.PSD.handles.BUTTONS.vb1 = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.14 0.925 0.05 0.04],...
                'cdata',Y3,...
            ...
            D.PSD.handles.BUTTONS.vb2 = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.2 0.925 0.05 0.04],...
                'cdata',Y4,...
        ...
        if ismember(5,objects.list) % zoom button
            D.PSD.handles.BUTTONS.vb5 = uicontrol(D.PSD.handles.hfig,...
                'style','togglebutton',...
                'units','normalized','Position',[0.26 0.925 0.05 0.04],...
                'cdata',Y7,...
        ...
        if ismember(6,objects.list) % scalp interpolation button
            D.PSD.handles.BUTTONS.vb1 = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.34 0.925 0.05 0.04],...
                'cdata',Y8,...
        ...
        if ismember(7,objects.list) % event selection button
            ...
            if objects.options.multSelect == 1
                set(D.PSD.handles.BUTTONS.pop1,...
                    ...
                    'value',trN,...
                    'units','normalized','Position',[0.55 0.834 0.35 0.13]);
            else
                trN = trN(1);
                set(D.PSD.handles.BUTTONS.pop1,...
                    'max',1,'min',length(D.PSD.trials.TrLabels)+1,...
                    'value',trN,...
                    'units','normalized','Position',[0.55 0.922 0.35 0.043]);%0.55 0.893 0.25 0.07
            end
%             set(D.PSD.handles.BUTTONS.pop1,'units','normalized');
        end
        ...
        if ismember(8,objects.list) % temporal sliders for source
            ...
            D.PSD.handles.BUTTONS.slider_step = uicontrol(D.PSD.handles.hfig,'style','slider',...
                'units','normalized','Position',[0.12 0.6 0.44 0.018],...
        ...
        if ismember(9,objects.list)  % add/goto event buttons
            D.PSD.handles.BUTTONS.sb1 = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.56 0.925 0.05 0.04],...
            ...
            D.PSD.handles.BUTTONS.sb2 = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.42 0.925 0.05 0.04],...
        ...
        if ismember(10,objects.list)  % source buttons positions...
            set(D.PSD.handles.BUTTONS.transp,...
                'units','normalized','position',[0.1 0.65 0.025 0.2],...
                'visible','on')
            set(D.PSD.handles.BUTTONS.ct1,...
                'units','normalized','position',[0.47 0.65 0.025 0.2],...
                'visible','on')
            set(D.PSD.handles.BUTTONS.ct2,...
                'units','normalized','position',[0.4975 0.65 0.025 0.2],...
                'visible','on')
            set(D.PSD.handles.colorbar,...
                'units','normalized','position',[0.53 0.65 0.025 0.2])
        end
        ...
        if ismember(11,objects.list)  % display switch (standard/scalp)...
            ...
            D.PSD.handles.BUTTONS.displaySwitch1 = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.42 0.945 0.1 0.02],...
...
%             set(D.PSD.handles.BUTTONS.displaySwitch1,'units','normalized')
            D.PSD.handles.BUTTONS.displaySwitch2 = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.42 0.925 0.1 0.02],...
...
%             set(D.PSD.handles.BUTTONS.displaySwitch2,'units','normalized')
        ...
        if ismember(12,objects.list)  % UPDATE button for data info modifs
            D.PSD.handles.BUTTONS.OKinfo = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.1 0.76 0.1 0.02],...
...
%             set(D.PSD.handles.BUTTONS.OKinfo,'units','normalized')
        ...
        if ismember(13,objects.list)  % switch 'bad' event status
            ...
            D.PSD.handles.BUTTONS.badEvent = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.91 0.925 0.05 0.04],...
                'style','pushbutton',...
...
%             set(D.PSD.handles.BUTTONS.badEvent,'units','normalized')
        ...
        if ismember(14,objects.list)  % show sensor positions
            D.PSD.handles.BUTTONS.showSensors = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.4 0.76 0.25 0.02],...
        ...
        if ismember(15,objects.list)  % save history as MATLAB script
            D.PSD.handles.BUTTONS.saveHistory = uicontrol(D.PSD.handles.hfig,...
                'units','normalized','Position',[0.1 0.76 0.2 0.02],...
                'style','pushbutton','string','Save as script',...
                'callback','spm_eeg_review_callbacks(''file'',''saveHistory'')',...
                'tooltipstring','Save history as MATLAB script',...
                'BusyAction','cancel',...
                'Interruptible','off',...
                'tag','plotEEG');
            set(D.PSD.handles.BUTTONS.saveHistory,'units','normalized')
        end
...
%                                     [p(1,end) p(2,end) 2*Lxrec*Pos(3) 2*Lxrec/Rxy*Pos(4)]);
            ...
            case 'source'
                ...
                if objects.options.Ninv>1
                    D.PSD.handles.BMCpanel = uipanel(...
                        'units','normalized','position',[0.42 0.05 0.5 0.25],...
                        'bordertype','beveledin',...
                        'BackgroundColor',0.95*[1 1 1],...
                        'tag','plotEEG');
                    D.PSD.handles.BMCplot = axes(...
                        'units','normalized','position',[0.5 0.1 0.4 0.15],...
                        'parent',D.PSD.handles.hfig,...
                        'box','on','visible','off',...
                        'tag','plotEEG');
                ...
                D.PSD.handles.axes2 = axes(...
                    'units','normalized','position',[0.14 0.35 0.4 0.2],...
...
%                     'box','on','hittest','off');
                ...
                D.PSD.handles.axes = axes(...
                    'units','normalized','position',[0.1 0.6 0.4 0.3],...
                    'parent',D.PSD.handles.hfig,'tag','plotEEG',...
