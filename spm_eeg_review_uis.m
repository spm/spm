...
switch objects.type
    ...
    case 'buttons'
        ...
        if ismember(8,objects.list) % temporal sliders for source
            ...
            D.PSD.handles.BUTTONS.slider_step = uicontrol(D.PSD.handles.hfig,'style','slider',...
                'Position',[0.18 0.6 0.44 0.018].*repmat(POS(3:4),1,2),...
...
%             D.PSD.handles.BUTTONS.focus_temp = uicontrol(D.PSD.handles.hfig,'style','edit',...
%                 'enable','on','callback','spm_eeg_review_callbacks(''visu'',''focus_t'',0)',...
%                 'value',pst(1),'BusyAction','cancel',...
%                 'Interruptible','off',...
%                 'Position',[0.63 0.6 0.15 0.02].*repmat(POS(3:4),1,2),'string',1,...
%                 'tag','plotEEG');
%             set(D.PSD.handles.BUTTONS.focus_temp,'units','normalized')
        end
        ...
        if ismember(10,objects.list)  % source buttons positions...
            set(D.PSD.handles.BUTTONS.transp,'position',[0.1 0.65 0.025 0.2],...
                'visible','on')
            set(D.PSD.handles.BUTTONS.ct1,'position',[0.65 0.65 0.025 0.2],...
                'visible','on')
            set(D.PSD.handles.BUTTONS.ct2,'position',[0.6775 0.65 0.025 0.2],...
                'visible','on')
            set(D.PSD.handles.colorbar,'position',[0.71 0.65 0.025 0.2])
        end
        ...
        if ismember(14,objects.list)  % show sensor positions
            D.PSD.handles.BUTTONS.showSensors = uicontrol(D.PSD.handles.hfig,'Position',...
                [0.425 0.76 0.095 0.02].*repmat(POS(3:4),1,2),...
                'style','pushbutton','string','show pos',...
    ...
    case 'axes'
        ...
        switch objects.what
            ...
            case 'source'
                ...
                D.PSD.handles.axes2 = axes('position',[0.2 0.35 0.4 0.2],...
                    'parent',D.PSD.handles.hfig,'tag','plotEEG',...
