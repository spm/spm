...
% $Id: spm_cfg_preproc.m 1295 2008-04-02 14:31:24Z volkmar $
...
for i=1:numel(nsub),
    ...
    if opts.biascor,
        ...
        cdep(end).tgt_spec   = cfg_findspec({{'class','cfg_files','strtype','e'}});
    end;
    for k1=1:3,
        if sopts(k1,3),
            cdep(end+1)            = cfg_dep;
