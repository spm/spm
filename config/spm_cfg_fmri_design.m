...
% $Id: spm_cfg_fmri_design.m 8119 2021-07-06 13:51:43Z guillaume $
...
fmri_design.val     = @fmri_design_cfg;
fmri_design.help    = {
...
%==========================================================================
function varargout = fmri_design_cfg
...
[cfg,varargout{1}] = deal({dir timing generic generic1 bases volt xGlobal gMT cvi });
