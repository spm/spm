...
% Will Penny
% $Id: spm_cfg_factorial_design.m 8119 2021-07-06 13:51:43Z guillaume $
...
factorial_design.val  = @factorial_design_cfg;
...
%==========================================================================
function varargout = factorial_design_cfg
...
[cfg,varargout{1}] = deal({dir des generic generic2 masking globalc globalm});
