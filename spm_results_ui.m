...
tmp = 'L = spm_XYZreg(''GetCoords'',hReg)'';';
...
uicontrol(Finter,'Style','Text','String','Volume level functions',...
	...
	'ForegroundColor','w')
uicontrol(Finter,'Style','PushButton','String','multiplanar','FontSize',Fs,...
	'Tag','hB_MultiPlanar',...
	'Callback','hMP = spm_results_ui(''LaunchMP'',M,DIM,hReg,gcbo);',...
	'Interruptible','on','Enable','on',...
