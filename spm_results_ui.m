...
% added to clear satfig if it exists
% ----------------------------------------------------------------------
hSat = findobj('tag','Satellite');
 
% This seems to work even when hSat is emmpty (i.e., it exits gracefully).
...
uicontrol(Finter,'Style','Text','String','RFX analyses',...
	'Position',[020 073 070 015].*WS,...
	'FontName',PF.times,'FontWeight','Normal','FontAngle','Italic',...
	'FontSize',FS(10),...
	'HorizontalAlignment','Left',...
	'ForegroundColor','w')
uicontrol(Finter,'Style','PushButton','String','RFX','FontSize',FS(10),...
	'ToolTipString',...
...
uicontrol(Finter,'Style','Text','String','Effective connectivity',...
	'Position',[135 168 94 015].*WS,...
	'FontName',PF.times,'FontWeight','Normal','FontAngle','Italic',...
	'FontSize',FS(10),...
	'HorizontalAlignment','Left',...
	'ForegroundColor','w')
uicontrol(Finter,'Style','PushButton','String','DCM',...
	'Position',[130 100 140 060].*WS,...
	'ToolTipString',...
	'Dynamic Causal Modeling',...
	'Callback','spm_dcm_ui(SPM,VOL,xX,xCon,xSDM,hReg)',...
	'Interruptible','on','Enable','on',...
...
uicontrol(Finter,'Style','PushButton','String','HDM','FontSize',FS(10),...
	'ToolTipString','Hemodynamic modeling of regional response',...
	'Callback','[Ep,Cp,K1,K2] = spm_hdm_ui(SPM,VOL,xX,xCon,xSDM,hReg)',...
	'Interruptible','on','Enable','on',...
...
uicontrol(Finter,'Style','Text','String','result controls',...
	'Position',[290 073 070 015].*WS,...
	'FontName',PF.times,'FontWeight','Normal','FontAngle','Italic',...
	'FontSize',FS(10),...
	'HorizontalAlignment','Left',...
	'ForegroundColor','w')
...
% ### CODE FOR SATELLITE FIGURE ###
% MODIFIED TO CLEAR SATELLITE FIGURE
...
% MODIFIED TO CLOSE SATELLITE FIGURE
