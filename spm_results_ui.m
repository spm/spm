...
text(0,00,sprintf('Extent threshold k = %0.0f voxels',SPM.k),   'Parent',hResAx)
...
uicontrol(Finter,'Style','PushButton','String','Hemodynamic model',...
	'FontSize',FS(10),...
...
if strcmp(MODALITY,'FMRI')
uicontrol(Finter,'Style','PushButton','String','PPIs','FontSize',FS(10),...
	'ToolTipString',...
	'create PPI regressors using deconvolved neuronal responses',...
	'Callback','PPI = spm_peb_ppi(SPM,VOL,xX,xCon,xSDM,hReg);',...
	'Interruptible','on','Enable','on',...
...
uicontrol(Finter,'Style','PushButton','String','plot','FontSize',FS(10),...
	...
	'Callback','[Y,y,beta,Bcov] = spm_graph(SPM,VOL,xX,xCon,xSDM,hReg);',...
	'Interruptible','on','Enable','on',...
