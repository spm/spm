...
% $Id: cfg_getfile.m 2091 2008-09-15 13:19:30Z volkmar $
...
uicontrol(fg,...
          'style','text',...
          'units','normalized',...
          'position',posinpanel([0 .9 1 .1],pselp),...
          lf,...
...
sel = uicontrol(fg,...
    'style','listbox',...
    'units','normalized',...
    'Position',posinpanel([0 0 1 .9],pselp),...
    lf,...
    'Callback',@unselect,...
    'tag','selected',...
...
uicontrol(fg,...
    'style','popupmenu',...
    'units','normalized',...
    'Position',posinpanel([0.12 0.05 0.86 .95*1/3],pdirp),...
    lf,...
