...
% parameters and differences in a further subset. in this demo,  we
% consider the full hierarchical inversion of a multisubject  study by
% updating the priors at the first level, using the eempirical priors from
...
% optimisation is informed by the sufficient statistics of the second
% level (namely the empirical priors). This should be contrasted with the
% summary statistic approach, in which the second level optimisation, based
% upon the sufficient statistics of the first level (posteriors and
% priors) are computed after convergence of the first level. The results of
% inversion are compared in terms of the second level posteriors (and the
% second level free energy over iterations). Specifically, we compare a
% gold standard (PEB) inversion, with the summary statistic approach to
...
% $Id: DEMO_BMR_PEB.m 6306 2015-01-18 20:50:38Z karl $
