...
% $Id: spm_help.m 1147 2008-02-13 19:04:59Z guillaume $
...
uicontrol(Fhelp,'Style','Text','String','special topics...',...
    ...
    'FontName',PF.helvetica,'FontAngle','Italic','FontWeight','Bold',...
...
uicontrol(Fhelp,'String',SPMc,...
    ...
    'FontName',PF.helvetica,'FontSize',8,...
    ...
    if d(1) == abs('%');
        ...
        if FmtLine
            set(h,'FontWeight','bold',...
                'FontName',PF.helvetica,'FontSize',FS(10));
            y = y - FS(8);
            FmtLine=0;
        end
        y = y - dy;
...
FS    = round(8*min(S_Gra));            % uicontrol font size
...
uicontrol(F,'String','SPMweb', 'Position',[x y sx+dx/2 sy],...
    ...
    'FontSize',FS,...
    'FontWeight','Bold','FontName',spm_platform('font','helvetica'),...
