...
O     = [600/2-400/2 100 0 0].*WS;		%-Offset for MenuWin plot
...
uicontrol(Fhelp,'String','Results',...
	'ToolTipString','interactive results section help [spm_results]',...
...
uicontrol(Fhelp,'String','Check Reg','FontSize',FS2,...
	'ToolTipString','about checking image registration [spm_check_registration]',...
