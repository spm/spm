...
uicontrol(Fhelp,'String','Defaults',...
	...
	'Tag','HelpMenu',...
	'Interruptible','on')
uicontrol(Fhelp,'String',spm('GetUser'),...
	'FontAngle','Oblique',...
...
uicontrol(F,'String','Print' ,'Position',[x y sx sy],...
	...
	'Tag','HelpBar','ForegroundColor','b'); x = x+sx;

uicontrol(F,'String','Clear' ,'Position',[x y sx sy],...
	'CallBack','spm_help(''!Clear'',gcf)',...
	'Interruptible','off','BusyAction','cancel',...
        'Tag','HelpBar','ForegroundColor','b'); x = x+sx+dx;
...
uicontrol(F,'String',sprintf('About %s',spm('Ver')),...
	...
	'CallBack','spm_help(''spm.man'')',...
	'Tag','HelpBar','ForegroundColor',[0 1 1])
...
uicontrol(F,'String','Menu',   'Position',[x y sx sy],...
	...
	'Interruptible','off','BusyAction','cancel',...
	'Tag','HelpBar','ForegroundColor',[0 1 1]), x = x+sx+dx;

uicontrol(F,'String','Help',   'Position',[x y sx sy],...
	'CallBack','spm_help(''spm_help.m'')',...
	'Interruptible','off','BusyAction','cancel',...
	'Tag','HelpBar','ForegroundColor','g'), x = x+sx+dx;
...
for h = findobj(get(F,'Children'),'Flat','HandleVisibility','on')'
	if ~any(strcmp(get(h,'Tag'),{'HelpBar','HelpMenu'})), delete(h), end
end
set(findobj(F,'Tag','HelpMenu'),'Visible','off')
set(findobj(F,'UserData','Topic'),'String','');
hRTopics   = findobj(F,'UserData','RefdTopics');
RefdTopics = get(hRTopics,'String');
set(hRTopics,'Value',1,'String',deblank(RefdTopics(1,:)))
