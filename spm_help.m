...
ob    = findobj(0,'Tag','spmtoolboxes');
utils = get(ob,'String');
mnames= get(ob,'UserData');
unames = {};
for i=1:length(mnames),
	if ~strcmp(mnames{i},';'),
		unames{i} = ['spm_help(''' mnames{i} ''')'];
	else,
		unames{i} = ';';
	end;
end;
