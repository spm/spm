...
uicontrol(Fhelp,'String','Normalize',...
	'Position',[150 370 100 30].*A,...
	'CallBack','spm_help(''Topic'',''spm_sn.man'');',...
	'Interruptible','yes');
