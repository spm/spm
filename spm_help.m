...
uicontrol(Fhelp,'String','Realign',...
	'ToolTipString','about realignment [spm_realign]',...
...
uicontrol(Fhelp,'Style','PopUp',...
	...
	'ToolTipString',['PET/SPECT/fMRI general linear model ',...
		'configuration [spm_{,fmri}_spm_ui]'],...
...
uicontrol(Fhelp,'String','Basic models',...
	'ToolTipString','about basic stats model setup [spm_spm_ui]',...
	'Position',[205 255 160 030].*WS+O,...
	'CallBack','spm_help(''spm_spm_ui'')',...
	'Tag','HelpMenu','Interruptible','on')
uicontrol(Fhelp,'String','Results',...
	'ToolTipString',...
		'results interrogation, contrasts etc. [spm_results_ui]',...
