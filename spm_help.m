...
%-Statistical...
uicontrol(Fhelp,'String','fMRI models','FontSize',FS(9),...
	'ToolTipString',...
...
uicontrol(Fhelp,'String','Utils','FontSize',FS(9),...
	'ToolTipString','menu utilities help [Menu_Utils_PullDown]',...
	'Position',[112 020 083 024].*WS+O,...
	'CallBack','spm_help(''Menu_Utils_PullDown'')',...
	'Tag','HelpMenu','Interruptible','on')
...
elseif strcmp(Topic,'MenuWin')
	S = sprintf([...
		...
		spm('Ver'),Usep,Usep);
elseif strcmp(Topic,'Menu_Utils_PullDown')
	S = sprintf([...
		...
		'%%               \n',...
		'%% 3) Show SPM:  Pops up all the figures for this SPM',...
			' session.\n',...
		'%%               Typing "spm show" in the MatLab command',...
			' window has the\n',...
		'%%               same effect.\n',...
		'%% 4) Run mFile: Prompts for selection of a MatLab M-file',...
			' (script or function with\n',...
		'%%               no arguments), which is then run in the',...
			' base workspace.\n',...
		'%% 5) SPMweb:    Opens http://www.fil.ion.ucl.ac.uk/spm',...
			' in your web browser.\n',...
