...
uicontrol(Fhelp,'String','Realign',...
	'ToolTipString','about realignment [spm_realign.m]',...
	'Position',[040 370 080 30].*WS+O,...
	'CallBack','spm_help(''spm_realign'')',...
	'Tag','HelpMenu','Interruptible','on')
uicontrol(Fhelp,'String','Normalize',...
	'ToolTipString','about spatial normalisation [spm_sn3d.m]',...
	'Position',[150 350 100 30].*WS+O,...
	'CallBack','spm_help(''spm_sn3d'')',...
	'Tag','HelpMenu','Interruptible','on')
uicontrol(Fhelp,'String','Smooth',...
	'ToolTipString','about spatial smoothing [spm_smooth_ui.m]',...
...
uicontrol(Fhelp,'String','Results',...
	'ToolTipString',...
		'results interrogation, contrasts etc. [spm_results.m]',...
