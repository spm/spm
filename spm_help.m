...
uicontrol(Fhelp,'String','Check Reg','FontSize',FS(9),...
	...
	'Tag','HelpMenu','Interruptible','on')
uicontrol(Fhelp,'String','Render','FontSize',FS(9),...
...
uicontrol(Fhelp,'String','PET/fMRI',...
	...
	'Tag','HelpMenu','Interruptible','on')
uicontrol(Fhelp,'String','Xtract Brain','FontSize',FS(9),...
...
uicontrol(Fhelp,'String','Utils','FontSize',FS(9),...
	'ToolTipString','menu utilities help [MenuWin:Utils_PullDown]',...
	'Position',[112 020 083 024].*WS+O,...
	'CallBack','spm_help(''MenuWin:Utils_PullDown'')',...
	'Tag','HelpMenu','Interruptible','on')
...
elseif strcmp(Topic,'MenuWin')
	S = sprintf([...
		...
		spm('Ver'),Usep,Usep);
elseif strcmp(Topic,'MenuWin:Utils_PullDown')
	S = sprintf([...
