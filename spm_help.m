...
uicontrol(Fhelp,'String','Normalize',...
	'ToolTipString','about spatial normalization [spm_normalise_ui]',...
	'Position',[150 330 100 30].*WS+O,...
	'CallBack','spm_help(''spm_normalise_ui'')',...
	'Tag','HelpMenu','Interruptible','on')
...
uicontrol(Fhelp,'String','Segment',...
	'ToolTipString','segmentation help [spm_segment_ui]',...
	'Position',[280 330 080 30].*WS+O,...
	'CallBack','spm_help(''spm_segment_ui'')',...
	'Tag','HelpMenu','Interruptible','on')
...
uicontrol(Fhelp,'String','ImCalc','FontSize',FS(9),...
	...
	'Tag','HelpMenu','Interruptible','on')
uicontrol(Fhelp,'String','Bias cor','FontSize',FS(9),...
	'ToolTipString','bias correction help [spm_bias_ui]',...
	'Position',[298 054 082 024].*WS+O,...
	'CallBack','spm_help(''spm_bias_ui'')',...
	'Tag','HelpMenu','Interruptible','on')
