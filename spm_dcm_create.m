...
% spm_dcm_generate.
%
% This function is very much like spm_dcm_specify
...
% $Id: spm_dcm_create.m 3705 2010-02-01 20:51:28Z karl $
...
switch upper(source_model)
    ...
    case 'GUI'
        ...
        U.u    = [];
        for  i = 1:length(Ui)
            % correct 32 bin offset that is inserted (as hard coded value!)
            % by spm_get_ons
