...
% Andrew Holmes
% $Id: spm.m 276 2005-11-02 10:05:31Z james $
...
uicontrol(Fmenu,'Style','PopUp',...
    'String','Other...|rereference|downsample|time-frequency|grand mean|merge|3Dimages',...
    ...
    'spm_eeg_grandmean;','spm_eeg_merge;','spm_eeg_make3dimage'},...
    'Tag', 'EEG')
