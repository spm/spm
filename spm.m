...
uicontrol(F,'String','PET and SPECT',...
	...
	'Position',[140 061 125 030],...
	'CallBack','delete(gcbf),clear all,spm(''PET'')',...
	'ForegroundColor',[0 1 1])

uicontrol(F,'String','EEG',...
	'ToolTipString',...
	'launch SPM-GUI in EEG modality (or type "spm eeg" in MatLab)',...
	'Position',[275 061 50 030],...
...
uicontrol(Fmenu,'Style','Text',...
	'String','SPM for EEG',...
	'ToolTipString','modality & defaults set for EEG',...
	'ForegroundColor',[1 1 1]*.6,'BackgroundColor',[1 1 1]*.8,...
...
uicontrol(Fmenu,'String','Segment',...
	...
	'FontSize',FS(10),...
	'UserData','jobs.spatial.segment',...
	'CallBack','spm_jobman(''interactive'','''',''jobs.spatial.segment'');',...
    'Tag', 'PETFMRI');
...
uicontrol(Fmenu,'String','Filter',...
    'Position',[150 380 100 030].*WS,...
	'ToolTipString','rereference EEG time-series',...
	'FontSize',FS(10),...
...
uicontrol(Fmenu,'Style','PopUp',...
	...
	'UserData',{	'spm_eeg_rereference;','spm_eeg_downsample|spm_eeg_tf|spm_eeg_grandmean|spm_eeg_merge;'},...
    'Tag', 'EEG')
...
uicontrol(Fmenu,'String','2D interpolation',...
	...
	'ToolTipString', '2D spline interpolation of ERP channel data',...
	'FontSize',FS(10),...
	'UserData','spm_eeg_convertmat2ana',...
	'CallBack','spm_eeg_convertmat2ana',...
	'Visible','off',...
    'Tag','EEG')

uicontrol(Fmenu,'String','3D source reconstruction',...
    'Position',[235 300 135 030].*WS,...
	'ToolTipString','3D source reconstruction of EEG data',...
	'FontSize',FS(10),...
    'UserData','',...
	'CallBack','',...
	'Visible','off',...
...
uicontrol(Fmenu,'String','fMRI',...
	...
	'FontSize',FS(10),...
	'CallBack','spm_jobman(''interactive'','''',''jobs.stats.fmri_stats'');',...
	'Visible','off',...
	'UserData','jobs.stats.fmri_stats',...
	'Tag','FMRI');
...
% Statistical EEG
%-----------------------------------------------------------------------
uicontrol(Fmenu,'String','ERP models (any level)',...
	'Position',[035 240 160 030].*WS,...
	'FontSize',FS(10),...
	'ToolTipString','ERP model',...
	'UserData','spm_eeg_spm_ui',...
	'CallBack','spm_eeg_spm_ui;',...
    'Tag', 'EEG');

uicontrol(Fmenu,'String','Review design',...
	'Position',[200 240 160 030].*WS,...
	'FontSize',FS(10),...
	'ToolTipString','review a specified model',...
	'UserData','spm_DesRep',...
	'CallBack','spm pointer watch, spm_DesRep; spm pointer arrow',...
...
uicontrol(Fmenu,'Style','PopUp',...
    'String','Display...|images|EEG',...
	'Position',[020 088 082 024].*WS,...
	'ToolTipString','orthogonal sections and EEG display',...
	'FontSize',FS(9),...
    'CallBack','spm(''PopUpCB'',gcbo)',...
...
uicontrol(Fmenu,'String','VBM Preproc',...
	'Position',[298 054 082 024].*WS,...
	'ToolTipString','This button is unused.  First come, first served',...
	'FontSize',FS(9),...
