...
% Andrew Holmes
% $Id: spm.m 375 2005-12-09 14:09:28Z john $
...
uicontrol(Fmenu,'String','3D source reconstruction',...
	...
	'ToolTipString','3D source reconstruction of EEG/MEG data (not functional yet)',...
	'FontSize',FS(10),...
    'UserData','',...
...
uicontrol(Fmenu,'String','EEG/MEG',...
	'Position',[75 240 110 030].*WS,...
	'FontSize',FS(10),...
	'ToolTipString','EEG and MEG models (any level)',...
	'UserData','spm_eeg_spm_ui',...
	'CallBack','spm_eeg_spm_ui;',...
    'Tag', 'EEG');
