...
F = figure('IntegerHandle','off',...
	...
	'Color',[1 1 1]*.8,...
	'MenuBar','none',...
	'DefaultUicontrolFontName',spm_platform('font','default'),...
	'HandleVisibility','off',...
	'Visible','off');

%-Text
%-----------------------------------------------------------------------
TimesFont = spm_platform('font', 'times');
hA = axes('Parent',F,'Position',[0 0 100/500 280/280],'Visible','Off');
text(0.5,0.5,'SPM',...
	'Parent',hA,...
	'FontName',TimesFont,'FontSize',96,...
...
uicontrol(F,'Style','Text','Position',[080 245 420 030],...
	...
	'FontName',TimesFont,'FontSize',18,'FontAngle','Italic',...
	'FontWeight','Bold',...
...
FS12 = 2*round(12*min(WS)/2);			%-Standard font size (12 scaled)
FS09 = round(9*min(WS));			%-Smaller font size  (09 scaled)
TimesFont = spm_platform('font', 'times');	%-Times font
...
uicontrol(Fmenu,'Style','Text','String','spatial',...
	...
	'ForegroundColor','w','FontName',TimesFont,'FontAngle','Italic')
...
uicontrol(Fmenu,'Style','Text',...
	...
	'ForegroundColor',[1 1 1]*.6,'BackgroundColor',[1 1 1]*.8,...
	'FontName',TimesFont,'FontAngle','Italic','FontWeight','Bold',...
	'HorizontalAlignment','center',...
...
uicontrol(Fmenu,'String','Results',	'Position',[035 215 330 030].*WS,...
	...
	'CallBack','[hReg,SPM,VOL,xX,xSDM]=spm_results_ui;',...
			'Visible','on',		'Tag','',	'Enable','off')
...
uicontrol(Fmenu,'String','Old Results',	'Position',[035 170 160 030].*WS,...
	'ToolTipString','results section for SPM97 analyses (from ML4)',...
	'CallBack','tmp_Res=''old''; spm_tmp_resrun',...
			'Visible','on',		'Tag','',	'Enable','on')

uicontrol(Fmenu,'String','New Results',	'Position',[205 170 160 030].*WS,...
	'ToolTipString','results section for SPM99 analyses (from ML5)',...
	'CallBack','tmp_Res=''new''; spm_tmp_resrun',...
			'Visible','on',		'Tag','',	'Enable','on')
...
uicontrol(Fmenu,'String','Xtract Brain', 'Position',[020 054 082 024].*WS,...
	...
	'FontSize',FS09,		'CallBack','spm_xbrain')
...
uicontrol(Fmenu,'Style','PopUp',...
	...
	'FontSize',FS09,		'CallBack','spm(''PopUpCB'',gcbo)',...
...
uicontrol(Fmenu,'String','Defaults',	'Position',[205 020 083 024].*WS,...
	...
	'FontSize',FS09,		'CallBack','spm_defaults_edit')
