...
uicontrol(F,'Style','Text','String',SPMver,...
	...
	'FontName',PF.times,'FontSize',14,'FontWeight','Bold',...
	'ForegroundColor','b')
...
Finter = figure('IntegerHandle','off',...
	...
	'Color',[1 1 1]*.7,...
	'MenuBar','none',...
	'DefaultUicontrolFontName',spm_platform('font','helvetica'),...
	'DefaultUicontrolFontSize',spm('FontSize',10),...
	'DefaultUicontrolInterruptible','on',...
	'Renderer', 'zbuffer',...
	'Visible',Vis);
varargout = {Finter};
