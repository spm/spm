...
uicontrol(Fmenu,'Style','PopUp',...
    'String','Other...|rereference|downsample|time-frequency|grand mean|merge',...
    ...
    'spm_eeg_grandmean;','spm_eeg_merge;'},...
    'Tag', 'EEG')
...
uicontrol(Fmenu,'String','EEG/MEG',...
	'Position',[150 240 95 030].*WS,...
	'FontSize',FS(10),...
	'ToolTipString','EEG and MEG models',...
	'UserData','spm_eeg_spm_ui',...
	'CallBack','spm_eeg_spm_ui;',...
    'Tag', 'EEG');

uicontrol(Fmenu,'String','Review design',...
	'Position',[250 240 110 030].*WS,...
	'FontSize',FS(10),...
	'ToolTipString','review a specified model',...
	'UserData','spm_DesRep',...
	'CallBack','spm pointer watch, spm_DesRep; spm pointer arrow',...
