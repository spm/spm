...
uicontrol(Fmenu,'String','Epoching',...
    'Position',[040 345 080 030].*WS,...
	'ToolTipString','epoch continuous EEG data',...
	'FontSize',FS(10),...
...
uicontrol(Fmenu,'String','Rereference',...
    'Position',[150 380 100 030].*WS,...
	'ToolTipString','rereference EEG time-series',...
	'FontSize',FS(10),...
    'UserData','spm_eeg_rereference',...
	'CallBack','spm_eeg_rereference;',...
    'Tag', 'EEG',...
    'Visible','off');

uicontrol(Fmenu,'String','Filter',...
    'Position',[280 380 080 030].*WS,...
	'ToolTipString','lowpass filter',...
	'FontSize',FS(10),...
...
uicontrol(Fmenu,'Style','PopUp',...
	...
	'UserData',{	'spm_image;','spm_eeg_display_ui;'},...
    'Tag', 'EEG')
