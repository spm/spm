...
uicontrol(Fmenu,'String','New Results',	'Position',[035 215 330 030].*WS,...
	'ToolTipString','interrogate model, contrasts etc.',...
	'ToolTipString','results section for SPM99 (ML5) analyses',...
...
uicontrol(Fmenu,'String','Old Results',	'Position',[035 170 160 030].*WS,...
	'ToolTipString','results section for SPM97 (ML4) analyses',...
	'CallBack','spm_results',...
			'Visible','on',		'Tag','',	'Enable','on')

uicontrol(Fmenu,'String','',		'Position',[205 170 160 030].*WS,...
	'ToolTipString','',...
