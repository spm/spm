...
uicontrol(Fmenu,'String','Results''98','Position',[035 215 330 030].*WS,...
	'ToolTipString','haven''t written this yet!',...
	'CallBack','disp(''Err, not yet!'')',		'Enable','off')
...
uicontrol(Fmenu,'Style','PopUp',...
	...
	'Position',[035 170 160 030].*WS,...
	'ToolTipString','assess results of a MatLab4 SPM97d analysis',...
	'FontSize',FS2,			'CallBack','spm(''PopUpCB'',gcbo)',...
	'UserData',{	'spm_results',...
			'spm_projections_ui',...
			'spm_projectionsF_ui'	})
