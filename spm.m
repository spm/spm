...
uicontrol(Fmenu,'String','Statistics',	'Position',[040 245 140 30].*WS,...
	'ToolTipString',...
	'General linear model for independent (PET/SPECT) data',...
	'CallBack','spm_spm_ui',...
	'Visible','off',		'Tag','PET'	,'Enable','off')

uicontrol(Fmenu,'String','Statistics',	'Position',[040 245 140 30].*WS,...
	'ToolTipString',...
	'General linear model for serially correlated (fMRI) data',...
...
uicontrol(Fmenu,'String','AdjMean',	'Position',[112 054 083 024].*WS,...
	'ToolTipString','compute adjusted mean images - PET/SPECT interface',...
	'CallBack','spm_adjmean_ui',...
	'Visible','off',		'Tag','PET')

uicontrol(Fmenu,'String','AdjMean',	'Position',[112 054 083 024].*WS,...
	'ToolTipString','compute adjusted mean images - fMRI interface',...
