...
% Andrew Holmes
% $Id: spm.m 1008 2007-11-23 17:02:08Z john $
...
Finter    = openfig('spm_Interactive');
varargout = {Finter};
return
...
if ~exist(fullfile(d,'spm_showdoc.m')), % This is a file that should not have changed
    if isunix,
        error(sprintf([...
