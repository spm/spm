...
%-Statistical
%-----------------------------------------------------------------------
uicontrol(Fmenu,'String','PET/SPECT models','Position',[035 245 160 030].*WS,...
...
uicontrol(Fmenu,'String','fMRI models',	'Position',[035 245 160 030].*WS,...
...
uicontrol(Fmenu,'String','Basic models','Position',[205 245 160 030].*WS,...
	'ToolTipString','basic stats  models for independent data',...
	'CallBack','spm_spm_ui(''cfg'',spm_spm_ui(''DesDefs_Stats''))')

uicontrol(Fmenu,'String','Results',	'Position',[035 175 330 030].*WS,...
...
Finter = figure('IntegerHandle','off',...
	...
	'DefaultUicontrolFontSize',spm('FontSize',09),...
	'DefaultUicontrolInterruptible','on',...
	'Renderer', 'zbuffer',...
	'Visible',Vis);
varargout = {Finter};
