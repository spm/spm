...
uicontrol(Fmenu,'Style','Text','String','spatial',...
	'Position',[025 405 350 020].*WS,'Tag','Empty',...
	'ForegroundColor','w','FontName','Times','FontAngle','Italic')

uicontrol(Fmenu,'Style','Frame',...
	'Position',[020 155 360 155].*WS,'Tag','Empty')
uicontrol(Fmenu,'Style','Text','String','statistical',...
	'Position',[025 285 350 020].*WS,'Tag','Empty',...
	'ForegroundColor','w','FontName','Times','FontAngle','Italic')
...
%-Statistical
%-----------------------------------------------------------------------
uicontrol(Fmenu,'String','Statistics',	'Position',[035 255 330 030].*WS,...
	'ToolTipString',...
	'general linear model & stats for independent data',...
	'CallBack','spm_spm_ui',...
	'Visible','off',		'Tag','PET'	,'Enable','off')
uicontrol(Fmenu,'String','fMRI Stats',	'Position',[035 255 160 030].*WS,...
	'ToolTipString',['general linear model & stats for serially ',...
		'correlated fMRI time series'],...
	'CallBack','spm_fmri_spm_ui',...
	'Visible','off',		'Tag','FMRI'	,'Enable','off')
uicontrol(Fmenu,'String','Stats',	'Position',[205 255 160 030].*WS,...
	'ToolTipString',...
	'general linear model & stats for independent data',...
	'CallBack','spm_spm_ui',...
	'Visible','off',		'Tag','FMRI'	,'Enable','off')

uicontrol(Fmenu,'String','Adjusted Means','Position',[035 215 330 030].*WS,...
	'ToolTipString',...
	'compute basic adjusted mean images',...
	'CallBack','spm_adjmean_ui',...
	'Visible','off',		'Tag','PET'	,'Enable','on')
uicontrol(Fmenu,'String','AdjMean/fMRI','Position',[035 215 160 030].*WS,...
	'ToolTipString','adjusted condition images for fMRI time series',...
	'CallBack','spm_adjmean_fmri_ui',...
	'Visible','off',		'Tag','FMRI'	,'Enable','on')
uicontrol(Fmenu,'String','AdjMean',	'Position',[205 215 160 030].*WS,...
	'ToolTipString',...
	'compute basic adjusted mean images',...
	'CallBack','spm_adjmean_ui',...
	'Visible','off',		'Tag','FMRI'	,'Enable','on')

uicontrol(Fmenu,'String','Results',	'Position',[035 165 080 040].*WS,...
	'ToolTipString','explore results at voxel & cluster level',...
	'CallBack','spm_results')
uicontrol(Fmenu,'String','SPM{Z}',	'Position',[115 185 080 020].*WS,...
	'FontSize',2*round(9*min(WS)/2),...
	'ToolTipString','summarise an SPM{Z}',...
	'CallBack','spm_projections_ui;')
uicontrol(Fmenu,'String','SPM{F}',	'Position',[115 165 080 020].*WS,...
	'FontSize',2*round(9*min(WS)/2),...
	'ToolTipString','summarise an SPM{F}',...
	'CallBack','spm_projectionsF_ui;')

uicontrol(Fmenu,'String','Eigenimages',	'Position',[205 170 160 030].*WS,...
	'ToolTipString','PCA of adjusted data',...
...
uicontrol(Fmenu,'Style','PopUp',...
	...
	'ToolTipString','misc utility functions',...
