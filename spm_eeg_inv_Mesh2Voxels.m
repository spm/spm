...
%======================================================================
% Non-linear interpolation of a Mesh texture into MNI Voxel space
% This routine is used to produce a 3D image canonical sMRI
% space (in voxel coordinates) from a cortical map (3D surface).
...
% classical SPM routine for statistical tests.
%
