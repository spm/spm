...
uicontrol(F,'Style','Text',...
    ...
    'Position',[100 240 390 030].*WS,...
    'FontName',PF.helvetica,'FontSize',16,'FontAngle','Italic',...
    'FontWeight','Bold',...
...
uicontrol(F,'Style','Text',...
    ...
    'String','Functional Imaging Laboratory',...
...
uicontrol(F,'Style','pushbutton',...
    ...
    'CallBack','spm(''Clean'');spm(''PET'');delete(gcbf);',...
...
uicontrol(F,'Style','pushbutton',...
    ...
    'CallBack','spm(''Clean'');spm(''EEG'');delete(gcbf);',...
    'FontName',PF.helvetica,...
    'ForegroundColor',[0.5 0 0]);
...
uicontrol(F,'Style','pushbutton',...
    ...
    'CallBack','spm(''Clean'');spm(''FMRI'');delete(gcbf);',...
    'FontName',PF.helvetica,...
    'ForegroundColor',[0.5 0 0]);
