...
switch action
    ...
    hResAx = axes('Parent',Fgraph,...
        'Position',[0.125 0.480 0.45 0.05],...
    ...
    uicontrol(Finter,'Style','PushButton','String','change data',...
