...
% Vladimir Litvak
% $Id: spm_config_meeg.m 1185 2008-03-04 16:31:21Z volkmar $
...
trlfile = struct('type','files','name','Define by TRL file','tag','trlfile',...
    'filter','*', 'num',[1 1], 'help',{{'Select an ASCII or matlab file with TRL structure (see definitrial() help)'}});
...
ctf = struct('type','files','name','Name of the channel template file','tag','ctf',...
    'filter','mat','num',[1 1], 'val', {{'empty.mat'}}, 'dir', fullfile(spm('dir'), 'EEGtemplates'), ...
