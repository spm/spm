...
%
% "columns to test" - misnomer - X0 is rest of design matrix
% effectively testing these columns after orthogonalisation wirit remainder
% 
% +1 -1  0  0   
%  0   0   1  0 
% +1 -1         
...
if isempty(I)
	...
	text(0.5,0.5,'no contrast(s)',...
		'FontSize',spm_figure('FontSizes',8),...
		'FontAngle','Italic',...
...
F = figure('IntegerHandle','off',...
		...
		'Position',[1152/2-250,900/2-200,500,400].*WS,...
		'Resize','off',...
		'Color',[1 1 1]*.7,...
		'MenuBar','none',...
...
uicontrol(F,'Style','Text','String','show',...
		'FontName','Times','FontAngle','Italic','FontSize',FS(8),...
		'ForegroundColor','w',...
...
h = uicontrol(F,'Style','ListBox','Tag','D_ConErrs',...
		...
		'FontName','Courier','FontSize',FS(7),...
		'ForegroundColor','r',...
