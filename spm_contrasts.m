...
for i = 1:length(Ic)
	...
	switch(xCon(ic).STAT)
	    ...
	    %-----------------------------------------------------------
	    xCon(ic).Vcon = struct(...
	        'fname',  fullfile(SPM.swd,sprintf('con_%04d.img',ic)),...
                'dim',    [SPM.xVol.DIM',16],...
                'mat',    SPM.xVol.M,...
                'pinfo',  [1,0,0]',...
	    ...
	    %-----------------------------------------------------------
            ...
            xCon(ic).Vcon            = spm_create_image(xCon(ic).Vcon);
	    ...
	    %-----------------------------------------------------------
	    xCon(ic).Vcon = struct(...
	        'fname',  fullfile(swd,sprintf('ess_%04d.img',ic)),...
                'dim',    [SPM.xVol.DIM',16],...
                'mat',    SPM.xVol.M,...
                'pinfo',  [1,0,0]',...
	...
	fname = fullfile(swd,sprintf('spm%c_%04d.img',xCon(ic).STAT,ic));
        xCon(ic).Vspm = struct(...
	    'fname',  fname,...
	    'dim',    [SPM.xVol.DIM',16],...
	    'mat',    SPM.xVol.M,...
