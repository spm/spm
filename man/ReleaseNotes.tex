...
Public updates are taking place frequently until the final release.
...
An implementation of the export of brain mapping statistical results using NIDM-Results is available from the batch editor in SPM \textgreater\ Stats \textgreater\ Results Report\ \textgreater Print results \textgreater\ NIDM.
