...
The group mean DCM parameters can be easily obtained from the MATLAB command window by loading the \verb!BMS.mat! file and then typing: \verb!mean_a=mean(BMS.DCM.ffx.bma.a,3)!. For the b, c and d parameters use the same code: \verb!mean_b=mean(...b,4)!, \verb!mean_c=mean(...c,3)! and \verb!mean_d=mean(...d,4)!. The subject specific mean DCM parameters can be obtained as follows: \verb!mean_as=mean(...as,4)!, \verb!mean_bs=mean(...bs,5)!, \verb!mean_cs=mean(...cs,4)! and\newline \verb!mean_ds=mean(...ds,5)!. For random-effects change \verb!ffx! to \verb!rfx!. 
