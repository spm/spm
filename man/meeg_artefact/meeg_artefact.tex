...
\caption{\em Time points where eye blinks were detected (top) and ligned blink time courses (bottom). \label{artefact_fig2}}
\end{center}
\end{figure}
...
\caption{\em Spatial confounds \label{artefact_fig3}}
\end{center}
\end{figure}
...
\caption{\em Spatial confounds \label{artefact_fig4}}
\end{center}
\end{figure}
...
\caption{\em Fieldtrip visual artefact rejection \label{artefact_fig5}}
\end{center}
\end{figure}
...
\caption{\em Fieldtrip visual artefact rejection \label{artefact_fig6}}
\end{center}
\end{figure}
