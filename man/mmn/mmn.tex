...
\end{itemize}
The progress bar will appear and the resulting filtered data will be saved in files \texttt{fdspm8\_subject1.mat} and \texttt{fdspm8\_subject1.dat}.  This step requires the Signal Processing Toolbox.
...
\begin{verbatim}
  1 bad channels: A14 
72 rejected trials: 1    3    4    5   27   28   29   88   98  110  125  [...]
\end{verbatim}
A new file will also be created, \texttt{aeMfdspm8\_subject1.mat}.
...
The cursor in Figure~\ref{3DSPM} has been positioned by selecting the third cluster in the results table. This occurs at time point 155ms post stimulus.
...
\item{Select the \texttt{maeMfdspm8\_subject1.mat} file.}
\end{itemize}
