...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=.3\textheight]{batch_template_single_subject_nodeps}

  \includegraphics[height=.3\textheight]{batch_template_single_subject}

  \includegraphics[height=.3\textheight]{batch_single_subject}
