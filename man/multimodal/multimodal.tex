...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_1}
...
You need to start SPM5 and toggle "EEG" as the modality (bottom-right of SPM main window), or start SPM5 with “spm eeg”.
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_2}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_3}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_4}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_5}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_6}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_7}
...
\begin{figure}
\includegraphics[width=70mm]{figures/figure_32_8}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_9}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_10}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_11}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_12}
...
\begin{figure}
\includegraphics[width=60mm]{figures/figure_32_13_L}
\includegraphics[width=60mm]{figures/figure_32_13_R}
...
\begin{figure}
\includegraphics[width=60mm]{figures/figure_32_14_L}
\includegraphics[width=60mm]{figures/figure_32_14_R}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_15}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_16}
...
\begin{figure}
\includegraphics[width=70mm]{figures/figure_32_17}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_18}
...
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_19}
...
.
\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_20}
...
This will produce a design matrix like that in Figure~\ref{fig_32_15}, which is stored in the file:
\begin{verbatim}
		fMRI/Stats/SPM.mat
\end{verbatim}

\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_21}
...
If the resulting SPM{F} is thresholded at $p<.05$ FWE corrected, the resulting MIP and table of values should be like that in Figure ~\ref{fig_32_16}. Only two regions survive correction: right fusiform and orbitofrontal cortex (note coordinates refer to native MRI space; not MNI space). These can be displayed on the (attentuation-corrected) structural msmri.nii. They are a subset of the regions identified by the same contrast in a group of 18 subjects in Henson et al (2003). At a lower threshold (e.g, $p<.01$ uncorrected), one can see additional activation in left fusiform, as well as other regions.


\begin{figure}
\includegraphics[width=100mm]{figures/figure_32_22}
...
\noindent 2. Friston, K, Carlton Chu, Janaina Mourão-Miranda, Oliver Hulme, Geraint Rees, Will Penny and John Ashburner (in press-b). Bayesian decoding of brain images. NeuroImage.\\
...
\noindent 17. Spinelli, L, Gonzalez S, Lantz, G, Seeck, M and Michel, C. (2000). Electromagntic inverse solutions in anatomically constrained spherical head models. Brain Topography, 13, 2.\\
