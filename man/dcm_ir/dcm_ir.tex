...
\caption{\em DCM window configured for the FnBn model.\label{dcm-ir:fig:1}}
\end{center}
\end{figure}
...
\caption{\em Four different models proposed by Chen et al. \cite{cc_asymm} \label{dcm-ir:fig:3}}
\end{center}
\end{figure}
...
\caption{\em Bayesian model comparison results.\label{dcm-ir:fig:6}}
\end{center}
\end{figure}
