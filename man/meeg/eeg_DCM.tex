\chapter{Dynamic Causal Modelling for evoked responses \label{Chap:eeg:DCM}}

Dynamic Causal Modelling for ERP/ERFs is described in
 \cite{od_dcm_erp} and \cite{sjk_dcm_erp}, see also\\
...
\cite{od_dcm_erp}. This interpretation 
