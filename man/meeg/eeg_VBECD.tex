...
\item if a pair of dipoles was added, you can then choose between ``soft´´ or ``hard´´ symmetric priors. A ``hard´´ prior enforces perfectly symmetric dipoles, i.e. there is a parameter reduction. A ``soft´´ prior imposes some (strong) correlation between the dipoles but lets them differ a little in location and moment.
