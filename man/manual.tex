...
\begin{figure}
\begin{center}
\epsfig{file=ui1,width=70mm}
\epsfig{file=ui2,width=70mm}
\epsfig{file=ui3,width=70mm}
\epsfig{file=ui4,width=70mm}
\end{center}
\caption{The SPM5 user interface. Top left: The usual user-interface.  Top right: The Defaults user-interface. Bottom left: The file selector (click the (?) button for more information about filtering filenames, or selecting individual volumes within a 4D file. Bottom right: more online help can be obtained via the main help button.}
\end{figure} 
