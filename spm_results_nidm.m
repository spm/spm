...
% Guillaume Flandin
% $Id: spm_results_nidm.m 6425 2015-04-29 18:24:51Z guillaume $
...
if isfield(SPM,'Sess') && isfield(SPM.xX,'K')
    ...
    extra_fields = {nidm_conv('nidm:hasDriftModel'),idDriftModel};
else
    extra_fields = {};
end
...
p.entity(idHeightThresh,{...
    ...
    nidm_conv('nidm:userSpecifiedThresholdType'),{ustt,'xsd:string'},...
    'prov:value',{TabDat.ftr{1,2}(1),'xsd:float'},... % xSPM.u
    nidm_conv('nidm:pValueUncorrected'),{TabDat.ftr{1,2}(2),'xsd:float'},...
    nidm_conv('nidm:pValueFWER'),{TabDat.ftr{1,2}(3),'xsd:float'},...
    });
...
if TabDat.ftr{2,2}(1) > 0
    extra_fields = {nidm_conv('nidm:pValueUncorrected'),{TabDat.ftr{2,2}(2),'xsd:float'},...
    nidm_conv('nidm:pValueFWER'),{TabDat.ftr{2,2}(3),'xsd:float'}};
else
    extra_fields = {nidm_conv('nidm:pValueUncorrected'),{1,'xsd:float'},...
    nidm_conv('nidm:pValueFWER'),{1,'xsd:float'}};
end
...
if numel(xSPM.Ic) == 1
    ...
    if xSPM.n == 1
        ...
        st = {'prov:type','nidm:kConjunctionInference', ...
              ...
              nidm_conv('nidm:globalNullDegree'),xSPM.n};
    end
end
...
p.entity(idSearchSpace,{...
    ...
    nidm_conv('spm:noiseFWHMInVoxels'),{xSPM.FWHM,'xsd:string'},...
    nidm_conv('spm:noiseFWHMInUnits'),{TabDat.ftr{7,2}(1:3),'xsd:string'},...
...
'spm:noiseFWHMInVoxels', 'spm:SPM_0000009';...
'spm:noiseFWHMInVertices', 'spm:SPM_0000008';...
'spm:noiseFWHMInUnits', 'spm:SPM_0000007';...
...
'nidm:globalNullDegree','nidm:NIDM_0000095';...
