...
p.add_namespace('crypto','http://id.loc.gov/vocabulary/preservation/cryptographicHashFunctions#');
...
%-Provenance
%--------------------------------------------------------------------------
p.entity('niiri:spm_results_id',{...
  'prov:type','prov:Bundle',...
  'prov:label','SPM Results',...
  'nidm:objectModel','nidm:SPMFmriResults',...
  'nidm:version',NIDMversion,...
  });
p.wasGeneratedBy('niiri:spm_results_id','niiri:software_id',now);
