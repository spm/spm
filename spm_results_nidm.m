...
% Guillaume Flandin
% $Id: spm_results_nidm.m 6081 2014-07-01 18:19:42Z guillaume $
...
p.entity('niiri:grand_mean_map_id',{...
...
p.wasGeneratedBy('niiri:grand_mean_map_id','niiri:model_pe_id');
...
for c=1:numel(xSPM.Ic)
    ...
    stat = xSPM.STAT; if strcmp(stat,'T'), stat = 't'; end
    p.entity(idSPM,{...
        ...
        'nidm:statisticType',{['nidm:' stat 'Statistic'],'xsd:string'},...
        'nidm:contrastName',{SPM.xCon(xSPM.Ic(c)).name,'xsd:string'},... %esc
...
for i=1:numel(idx)
    ...
    p.wasDerivedFrom(['niiri:cluster_' iClus],'niiri:excursion_set_id');
end
