...
% Guillaume Flandin
% $Id: spm_results_nidm.m 6143 2014-09-01 10:58:20Z guillaume $
...
if ~isempty(gz), niifmt = 'nidm:NIfTI1Gzip'; else niifmt = 'nidm:NIfTI1'; end
...
if strcmp(spm_file(file,'ext'),'gz'), Gzipped = 'Gzip'; else Gzipped = ''; end
p.entity(id,{...
    'prov:type','nidm:Map',...
    'nidm:originalFileName',{spm_file(file,'filename'),'xsd:string'},...
    'dct:format',['nidm:NIfTI1' Gzipped],...
