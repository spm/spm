...
% Guillaume Flandin
% $Id: spm_results_nidm.m 6603 2015-11-20 19:53:29Z guillaume $
...
p.agent(idSoftware,{...
    ...
    nidm_conv('nidm_exporterVersion',p),...
        {char(regexp(SVNrev,'\$Rev: (\d.*?) \$','tokens','once')),'xsd:string'},...
    });
...
'nidm:NIDM_0000164', 'nidm_exporterVersion';...
