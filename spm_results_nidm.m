...
% Guillaume Flandin
% $Id: spm_results_nidm.m 6131 2014-08-01 19:56:14Z guillaume $
...
%--------------------------------------------------------------------------
files.tspm = fullfile(outdir,['spm' xSPM.STAT '_thresholded' '.nii' gz]);
...
p.entity(idMask1,{...
    ...
    'nidm:originalFileName',{spm_file(SPM.VM.fname,'filename'),'xsd:string'},...
...
for i=1:numel(SPM.Vbeta)
    if ~isempty(files.beta)
        extra_fields = {...
            'nidm:originalFileName',{spm_file(SPM.Vbeta(i).fname,'filename'),'xsd:string'},...
...
p.entity(idResMS,{...
    ...
    'nidm:originalFileName',{spm_file(SPM.VResMS.fname,'filename'),'xsd:string'},...
    'nidm:atCoordinateSpace',id_data_coordspace,...
...
p.entity(idRPV,{...
    ...
    'nidm:originalFileName',{spm_file(SPM.xVol.VRpv.fname,'filename'),'xsd:string'},...
    'nidm:atCoordinateSpace',id_data_coordspace,...
...
for c=1:numel(xSPM.Ic)
    ...
    p.entity(idSPM,{...
        ...
        'nidm:statisticType',['nidm:' xSPM.STAT 'Statistic'],...
        'nidm:contrastName',{SPM.xCon(xSPM.Ic(c)).name,'xsd:string'},... %esc
        'nidm:originalFileName',{spm_file(SPM.xCon(xSPM.Ic(c)).Vspm.fname,'filename'),'xsd:string'},...
    ...
    if xSPM.STAT == 'T'
        ...
        p.entity(idContrast,{...
            ...
            'nidm:contrastName',{SPM.xCon(xSPM.Ic(c)).name,'xsd:string'},... %esc
            'nidm:originalFileName',{spm_file(SPM.xCon(xSPM.Ic(c)).Vcon.fname,'filename'),'xsd:string'},...
            'nidm:atCoordinateSpace',id_data_coordspace,...
