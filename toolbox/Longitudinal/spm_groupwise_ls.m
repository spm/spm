...
%
% This function requires an obscene amount of memory.  If it crashes with an "Out of memory"
% error, then do not be too surprised.
%_______________________________________________________________________
% Copyright (C) 2012 Wellcome Trust Centre for Neuroimaging

% John Ashburner
% $Id: spm_groupwise_ls.m 4671 2012-03-02 19:40:35Z john $
