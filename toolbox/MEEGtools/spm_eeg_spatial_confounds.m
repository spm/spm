...
% Vladimir Litvak
% $Id: spm_eeg_spatial_confounds.m 2728 2009-02-11 09:58:07Z vladimir $
...
if spm_input('How to define?','+1','SVD|BESA',[0 1], 0);
    ...
    for i = 1:numel(cl)
        svdinput = [svdinput mean(D.selectdata(D.chanlabels(setdiff(D.meegchannels, D.badchannels)), timewin, cl{i}), 3)];
    end
    [U S V] = spm_svd(svdinput);
