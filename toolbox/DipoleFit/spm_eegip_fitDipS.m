function [sdip,fit_opt] = spm_eegip_fitDipS(V,model,Vbr,n_dip,n_seeds,fit_opt,disp_f,MCS_f)

% FORMAT [sdip,set_loc_o] = spm_eegip_fitDipS(V,model,Vbr,n_dip,n_seeds,fit_opt,disp_f,MCS_f)
%
...
if ~MCS_f
    ...
    [fit_opt.set_loc_o] = spm_eegfp_vert2Rsph(1,model.spheres,fit_opt.set_loc_o);
...
for ii=1:n_seeds
    [sdip.loc{ii}] = spm_eegfp_vert2Rsph(2,model.spheres,sdip.Sloc{ii});
    if disp_f
        if n_dip==1
