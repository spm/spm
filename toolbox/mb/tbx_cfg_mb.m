...
mb.help        = {['This framework attempts to unify ``unified segmentation'''' with ``shoot'''', '...
                    ...
                    'This work was mostly funded by the EU Human Brain Project’s Grant Agreement No 785907 (SGA2), with the library for the empirical Bayesian mixture model funded by the MRC and Spinal Research Charity through the ERA-NET Neuron joint call (MR/R000050/1).',...
                    ''};
% ---------------------------------------------------------------------
