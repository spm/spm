...
% $Id: tbx_cfg_mb.m 7951 2020-09-20 10:08:01Z guillaume $
...
mu_prov.help    = {['The model can be run using a pre-computed template, or it can implicitly '...
...
aff.values      = {'', 'T(3)', 'SE(3)'};
aff.val         = {'SE(3)'};
aff.help        = {['Type of affine transform to use in the model, which may be either '...
...
dff.help        = {['Specify the regularisation settings for the diffeomorphic registration. '...
...
out.help = {['When ``Fit Multi-Brain model'' is run, the resulting model fit contains '...
             ...
             'If they can not be found, then ``Output'' will crash out in a not very elegant way.'],''};
% ---------------------------------------------------------------------
