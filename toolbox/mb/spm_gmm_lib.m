...
% $Id: spm_gmm_lib.m 8008 2020-11-17 10:13:34Z john $
...
for em=1:iter_max
    ...
    for i=1:subiter_max
        ...
        do_iterate = numel(SS0m)~=1 || size(ss1m{1},1)<size(mu,1);
        if do_iterate, subsubiter_max = 1; else subsubiter_max = 4; end
        ...
        if ~do_iterate || subgain < subtolerance
            break
        end
    end
