...
mb.help        = {...
    ...
    ['Note that there can be issues if images in floating point format are used, '...
     'unless missing data is assigned a value of NaN (rather than zero) and '...
     'the intensity distribution ranges continuously (i.e. is not just delta functions '...
