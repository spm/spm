...
% G.tissue - tissue types of voxels [3 x # voxels] 
% 1-scalp, 2-CSF, 3-gray matter, 4-white matter 
%__________________________________________________________________________
% Copyright (C) 2015 Wellcome Trust Centre for Neuroimaging

% Will Penny & Sungho Tak
% $Id: estimate_greens_mmclab.m 6418 2015-04-23 08:40:08Z sungho $
...
%--------------------------------------------------------------------------
cfg.nphoton = 1e1; % the number of photons for MC simulation
...
G.xyz = vol.mat * [node; ones(1, size(node, 2))]; G.xyz(4,:) = []; 
G.elem = elem; 
