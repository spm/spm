...
% computes t-stat accross trials for evoked response
% FORMAT BF = bf_stat_t(S)
%   S               - input structure
%  fields of S:
...
%   S.MNI       - flag to output in MNI space - logical    -Default: 1
%   S.summary   - output summary statistic  - logical      -Default: 0 
% Output:
...
if ~isfield(S, 'MNI'),          S.MNI = 1; end
if ~isfield(S, 'summary'),      S.summary = 0; end
