...
% decision process. This model and inference scheme is formulated in
...
% hidden states. Similarly, for simplicity, this routine assumes that
% action and hidden controls are isomorphic. If the dynamics of transition
...
%
% Note that the conditional expectations are functions of time but also
