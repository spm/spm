...
%
% This demonstration routine replicates the 20 questions demonstration, in
% which to agents ask each other questions to resolve uncertainty about a
% scene that is seen by only one of the agents. This replication replaces
% one of the agents with the user by equipping the generative model with a
% fast (first) hierarchical level. This effectively maps from spoken
% dialogue (i.e., acoustic streams) to the lexical outcomes generated by
% the semantic (second) level of the model. The semantic level is, in turn,
% generating outcomes (and receiving empirical priors) from a conceptual
% (third) level.
% 
% In effect, this provides a deep (three level) generative model that
% covers fast timescales of evidence accumulation, implicit in voice
% recognition (and generation), to the slow belief updating at the
% conceptual level – resolving uncertainty about the configuration of the
% scene.
% 
% As in the original 20 questions demo, this scene comprises two objects,
% where the upper and lower objects can be squares or triangles – and can
% be red or green. In this demo, the agent first asks questions that the
% user can respond to (when presented with a recording prompt). The ensuing
% belief updating is shown in terms of posterior beliefs about the
% configuration of the scheme (i.e., large objects in the lower left of the
% appropriate graphics window). The true scene is depicted by the smaller
% graphics. By changing various options, one can also plot the segmentation
% of the audio file input during active listening. We then switch roles so
% that the user has to ask questions to discern the hidden configuration of
% the objects.
% 
% The subfield of the MDP structure called VOX determines who generates
% (and recognises) spoken words at each of the three trials; i.e.,
% preparatory, question and answer trials. There is also an option to train
% the prosody of the exchanges by repeating questions and answers if the
% options variable TRAIN is switched on.
%
...
%% second level (narrative or conceptual)
%==========================================================================
% question 1: {'noun (7)'}
% question 2: {'noun (7)','adverb (9)'}
% question 3: {'adjective (8)','noun (7)','adverb (9)'}
...
%% train prosody
%==========================================================================
% If invoked, training will accumulate Dirichlet parameters mapping from
% hidden states to prosody outcome modalities
%--------------------------------------------------------------------------
if TRAIN
...
%==========================================================================
% Now, demonstrate a verbal exchange, where the user is first prompted for
% answers.
%--------------------------------------------------------------------------
TRAIN = 0;
% Now, demonstrate a verbal exchange, where the user is first prompted for
% answers.
% 
% Now switch roles, so that the user asks questions to discern the
% underlying configuration (shown in the figure).
