...
% points play the role of an echo-state and enable the learning or
...
% beliefs about ensuing eyelinks and unconditioned responses (which
...
% expectations about the CS (for delay conditioning) and and extrasensory
% course (for trace conditioning): see the functions at the end of this
% routine.
%__________________________________________________________________________
