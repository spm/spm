...
for t = 1:T
    ...
    for m = M(t,:)
        ...
        % write predictive density over paths to outputs, if specified
        %==================================================================
        if isfield(id{m},'gu')
            for g = 1:numel(id{m}.gu)
                f = id{m}.gu{g};
                if numel(f)
                    O{m,g,t} = P{m,f,t};
                end
        ...
        if t > 1
            ...
            for f = 1:Nf(m)
                ...
                % prior predictive density over paths
                %----------------------------------------------------------
                if U{m}(f)
                    u               = V{m}(k,f);
                    P{m,f,t - 1}(:)   = 0;
            ...
            if process(m)
                ...
                if isfield(id{m},'gu')
                    ...
                    % implicit action (sample action from predictive prior)
                    %------------------------------------------------------
