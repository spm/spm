...
% MDP.C{G}(O,1)         - prior probabilities over outcomes       (Dirichlet counts)
...
for m = 1:Nm
    ...
    % replace marginal end states H{f} if specified as hid
    %----------------------------------------------------------------------
