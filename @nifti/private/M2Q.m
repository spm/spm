...
if t>0.5,
    ...
    case 1,
        ...
        Q = [0.25*s (M(1,2)+M(2,1))/s (M(3,1)+M(1,3))/s (M(2,3)-M(3,2))/s]';
    case 2,
        s = 2*sqrt(1 + M(2,2) - M(1,1) - M(3,3));
        Q = [(M(1,2)+M(2,1))/s 0.25*s (M(2,3)+M(3,2))/s (M(3,1)-M(1,3))/s ]';
    case 3,
        s = 2*sqrt(1 + M(3,3) - M(1,1) - M(1,1));
        Q = [(M(3,1)+M(1,3))/s (M(2,3)+M(3,2))/s 0.25*s (M(1,2)-M(2,1))/s]';
    end;
end;
