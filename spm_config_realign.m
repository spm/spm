...
% John Ashburner
% $Id: spm_config_realign.m 112 2005-05-04 18:20:52Z john $
...
'higher degree interpolation generally gives better results. ',...
'Although higher degree methods provide better interpolation, but they are slower ',...
'because they use more neighbouring voxels. ',...
'Fourier Interpolation is another option, but note that it ',...
'only works for purely rigid body transformations.  Voxel sizes must all be ',...
